...
class TestParseVersionToFloat:
    ...
    def test_parse_version_to_float_semantic_version(self) -> None:
        ...
        assert parse_version_to_float("2.0.0") == 2.0  # Patch 0 -> no suffix
        assert parse_version_to_float("2.0.1") == 2.01  # Include patch
        assert parse_version_to_float("1.4.2") == 1.42  # Include patch
        assert parse_version_to_float("3.14.15") == 3.1415  # Include patch
    ...
    def test_parse_version_to_float_edge_cases(self) -> None:
        ...
        assert parse_version_to_float("0.0.1") == 0.01  # Include patch for 0.0.x
        assert parse_version_to_float("0.0.0") == 0.0  # Patch 0 -> no suffix
        assert parse_version_to_float("10.20.30") == 10.2030  # Include patch
